...
//zmienić z index na id tutaj i w zaznaczaniu zadania 
    ...
    // const whichLiElementIsClicked = () => {
    //     setClickedLiElementIndex(task.index)
    // }
    ...
    return (
        <div className="checklist-section">
            ...
            <p className="checklist__current-task">
                {tasks.map((task) => (
                    clickedLiElementIndex === task.index ? task.text : ''
                ))}
            </p>
            ...
            <div>
                <ul className="checklist__ul-tasks-box">
                    ...
                    .map((task) => (
                        <li key={task.index} 
                            className={`checklist__task-item ${clickedLiElementIndex === task.index ? 'clicked-li-element' : ''}`} 
                            onClick={() => setClickedLiElementIndex(task.index)}
                        >
